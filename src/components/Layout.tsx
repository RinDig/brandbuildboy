...
export function Layout({ children, brandKey }: LayoutProps) {
  ...
  const themeVars: CSSProperties & Record<string, string> = {
    ...
    "--brand-top-nav-chip-bg": brand.colors.topNavChipBg,
    "--brand-top-nav-chip-text": brand.colors.topNavChipText,
    "--brand-top-nav-primary-bg": brand.colors.topNavPrimaryBg,
    "--brand-top-nav-primary-text": brand.colors.topNavPrimaryText,
    "--brand-surface": brand.colors.surface,
    "--brand-surface-text": brand.colors.surfaceText,
    "--brand-surface-muted": brand.colors.surfaceMuted,
    "--brand-line": brand.colors.line,
    "--brand-card": brand.colors.card,
    "--brand-action-bg": brand.colors.actionBg,
    "--brand-action-text": brand.colors.actionText,
    "--brand-cta-band-start": brand.colors.ctaBandStart,
    "--brand-cta-band-end": brand.colors.ctaBandEnd,
    "--brand-cta-band-text": brand.colors.ctaBandText,
    "--brand-cta-button-bg": brand.colors.ctaButtonBg,
    "--brand-cta-button-text": brand.colors.ctaButtonText,
    "--brand-success-dot": brand.colors.successDot,
    "--brand-danger": brand.colors.danger,
    "--brand-font-body": brand.fonts.body,
    "--brand-font-mono": brand.fonts.mono,
  };
    ...
    <div className={styles.frame} style={themeVars} data-brand={brand.key}>
      ...
      <nav className={styles.topNav}>
        ...
        <div className={styles.navArrowRight}>
          <ArrowCorner mirror color="var(--brand-line)" />
        </div>
      </nav>
        ...
        <button className={styles.bookCallButton}>
          <div className={styles.bookCallOuter}>
            <div className={styles.bookCallInner}>
              <div className={styles.bookCallInner}>
                <span className={styles.bookCallTitle}>{brand.copy.bookCallLabel}</span>
                <span className={styles.bookCallSubtitle}>
                  {brand.copy.bookCallSubLabel}
                </span>
              </div>
            </div>
          </div>
        ...
        <button className={styles.ctaButton}>
          ...
          <div className={styles.ctaOuter}>
            <div className={styles.ctaInner}>
              <span className={styles.ctaText}>{brand.copy.footerCtaLabel}</span>
            </div>
          </div>
        </button>
      </nav>
